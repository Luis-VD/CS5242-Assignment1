...
def load_data():
    ...
    with open('../Question_2_1/x_train.csv') as csvfile:
    ...
    with open('../Question_2_1/x_test.csv') as csvfile:
        r = csv.reader(csvfile, delimiter='\n', quotechar='|')
        for row in r:
            str = row[0].split(',')
            arr = list(map(int, str))
    ...
    with open(
            '../Question_2_1/y_train.csv') as csvfile:
        r = csv.reader(csvfile, delimiter='\n')
        for row in r:
            if row[0] == '0':
    ...
    with open(
            '../Question_2_1/y_test.csv') as csvfile:
        r = csv.reader(csvfile, delimiter='\n')
        for row in r:
            if row[0] == '0':
